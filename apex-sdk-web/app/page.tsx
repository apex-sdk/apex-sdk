      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": "The System Chain Standard Library for building specialized apps on Polkadot Asset Hub, Revive, and PolkaVM",
            "offers": {
              "@type": "Offer",
              "price": "0",
              "priceCurrency": "USD"
      ...
      <main className="min-h-screen bg-obsidian text-white selection:bg-hyperBlue-dim selection:text-hyperBlue font-sans pb-20">
        ...
        <section className="min-h-screen flex flex-col justify-center pt-20 pb-24 px-6 relative overflow-hidden">
          ...
          <div className="max-w-5xl mx-auto text-center relative z-10">
            <h1 className="text-6xl md:text-8xl lg:text-9xl font-black tracking-tight mb-8 text-gradient-hero bg-clip-text">
              The System Chain Standard Library
            </h1>

            <div className="mb-6">
              <h2 className="text-xl md:text-2xl text-white/90 font-medium mb-2">
                Build specialized, high-performance apps for Polkadot Asset Hub, Revive, and PolkaVM
              </h2>
              <p className="text-lg md:text-xl text-white/70 max-w-3xl mx-auto leading-relaxed">
                Apex SDK is the open-source standard for system chain development. Type-safe APIs, blazing fast Rust performance, and unified tooling for the next generation of Polkadot builders.
              </p>
            </div>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="border border-gray-700 rounded-xl p-8 transition-all duration-300" style={{
                ...
                <h3 className="text-xl font-semibold mb-4 text-hyperBlue">Native Asset Hub Integration</h3>
                <p className="text-white/70 mb-4">
                  High-level APIs for managing assets, NFTs, and balances on Polkadot Asset Hub. Seamless integration with system parachains.
                </p>
                <Link href="/docs/substrate" className="text-hyperBlue hover:underline text-sm font-medium">
                  Asset Hub Guide →
                </Link>
              </div>
              ...
              <div className="border border-gray-700 rounded-xl p-8 transition-all duration-300" style={{
                ...
                <h3 className="text-xl font-semibold mb-4 text-hyperBlue">Revive Protocol Support</h3>
                <p className="text-white/70 mb-4">
                  Native support for the Revive protocol, enabling asset recovery and cross-chain migration patterns unique to Polkadot.
                </p>
                <Link href="/docs/revive" className="text-hyperBlue hover:underline text-sm font-medium">
                  Revive Integration →
                </Link>
              </div>
              ...
              <div className="border border-gray-700 rounded-xl p-8 transition-all duration-300" style={{
                ...
                <h3 className="text-xl font-semibold mb-4 text-hyperBlue">PolkaVM & Solidity Contracts</h3>
                <p className="text-white/70 mb-4">
                  Deploy and interact with Solidity smart contracts on Polkadot Asset Hub using the high-performance PolkaVM backend.
                </p>
                <Link href="/docs/api" className="text-hyperBlue hover:underline text-sm font-medium">
              ...
              <div className="border border-gray-700 rounded-xl p-8 transition-all duration-300" style={{
                ...
                <h3 className="text-xl font-semibold mb-4 text-hyperBlue">Modular Crate Architecture</h3>
                <p className="text-white/70 mb-4">
                  Apex SDK is built with a modular, crate-based architecture. Only include the modules you need for your specific system chain.
                </p>
                <Link href="/docs/installation" className="text-hyperBlue hover:underline text-sm font-medium">
                  Installation Guide →
                </Link>
              </div>
        ...
        <section className="py-24 px-6" id="networks">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-bold tracking-tight mb-6">
                Polkadot System Chains & Beyond
              </h2>
              <p className="text-xl text-white/70 max-w-3xl mx-auto">
                Built specifically for the Polkadot ecosystem. Apex SDK provides a unified interface for Asset Hub, Revive, and the entire relay-parachain matrix.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              ...
              <div className="border border-gray-700 rounded-xl p-8" style={{
                ...
                <h3 className="text-2xl font-semibold mb-6 text-hyperBlue">Polkadot System Chains</h3>
                <div className="grid grid-cols-2 gap-4 mb-6">
                  <div className="text-white/80">• Asset Hub</div>
                  <div className="text-white/80">• Revive Protocol</div>
                  <div className="text-white/80">• PolkaVM</div>
                  <div className="text-white/80">• Collectives</div>
                  <div className="text-white/80">• Bridge Hub</div>
                  <div className="text-white/80">• People Chain</div>
                  <div className="text-white/80">• Encointer</div>
                  <div className="text-white/80">• Coretime</div>
                </div>
              ...
              <div className="border border-gray-700 rounded-xl p-8" style={{
                ...
                <h3 className="text-2xl font-semibold mb-6 text-hyperBlue">Ecosystem & Parachains</h3>
                <div className="grid grid-cols-2 gap-4 mb-6">
                  <div className="text-white/80">• Polkadot Relay</div>
                  <div className="text-white/80">• Kusama Relay</div>
                  <div className="text-white/80">• Westend Testnet</div>
                  ...
                  <div className="text-white/80">• Custom Chains</div>
                </div>
                <Link href="/docs/ecosystem" className="text-hyperBlue hover:underline font-medium">
                  Ecosystem Overview →
                </Link>
              </div>
            </div>
        ...
        <section className="py-24 px-6 relative" id="use-cases" style={{
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-white/70 max-w-3xl mx-auto">
                See how developers are using the System Chain Standard Library to build the next generation of Polkadot applications
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="border border-gray-700 rounded-xl p-8 transition-all duration-300" style={{
                ...
                <h3 className="text-xl font-semibold mb-4 text-hyperBlue">System Chain DeFi</h3>
                <p className="text-white/70 mb-4">
                  Build decentralized exchanges and lending protocols natively on Asset Hub with deep integration into Polkadot's shared security.
                </p>
              ...
              <div className="border border-gray-700 rounded-xl p-8 transition-all duration-300" style={{
                ...
                <h3 className="text-xl font-semibold mb-4 text-hyperBlue">Native Asset Recovery</h3>
                <p className="text-white/70 mb-4">
                  Implement sophisticated asset recovery and migration patterns using the Revive protocol, ensuring user funds are always protected.
                </p>
                <Link href="/docs/revive" className="text-hyperBlue hover:underline text-sm font-medium">
                  Revive Examples →
                </Link>
              ...
              <div className="border border-gray-700 rounded-xl p-8 transition-all duration-300" style={{
                ...
                <h3 className="text-xl font-semibold mb-4 text-hyperBlue">PolkaVM Contract Deployment</h3>
                <p className="text-white/70 mb-4">
                  Scale your Solidity applications on Polkadot with PolkaVM, achieving unparalleled performance and lower execution costs.
                </p>
                <Link href="/docs/api" className="text-hyperBlue hover:underline text-sm font-medium">
                  Contract Examples →
                </Link>
